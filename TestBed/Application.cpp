...
int main() {
	...
	gameObject.AddComponent<RigidBody>(new RigidBody(gameObject, 50, 50, 1, false, Math::Vector3(1, 0, 0), Math::Vector3(0, 0, 0)));
	...
	gameObject2.AddComponent<RigidBody>(new RigidBody(gameObject2, 50, 50, 1, false, Math::Vector3(-1, 0, 0), Math::Vector3(0, 0, 0)));
