...
int main() {
	...
	gameObject.AddComponent<RigidBody>(new RigidBody(gameObject, .05, 50, 1, false , Math::Vector3(0, 0, 0), Math::Vector3(10, 10, 10)));
	...
	//gameObject2.AddComponent<RigidBody>(new RigidBody(gameObject2, 50, 50, 1, false, Math::Vector3(0, 0, 0), Math::Vector3(10, 10, 10)));
